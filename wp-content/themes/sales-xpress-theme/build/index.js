...
/* harmony import */ var _modules_TestimonySlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/TestimonySlider */ "./src/modules/TestimonySlider.js");
/* harmony import */ var _modules_Search__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Search */ "./src/modules/Search.js");
/* harmony import */ var _modules_NavMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/NavMenu */ "./src/modules/NavMenu.js");
...
const testimonySlider = new _modules_TestimonySlider__WEBPACK_IMPORTED_MODULE_1__["default"]();
const search = new _modules_Search__WEBPACK_IMPORTED_MODULE_2__["default"]();
const navMenu = new _modules_NavMenu__WEBPACK_IMPORTED_MODULE_3__["default"]();
const smoothScroll = new _modules_Search__WEBPACK_IMPORTED_MODULE_2__["default"]();
...
class NavMenu {
  constructor() {
    this.navMobileMenu = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".mobile-menu");
  ...
  navMobileMenuClickHandler(event) {
    if (!event.target.closest(".mobile-menu") && this.header.hasClass("active")) {
...
class Search {
  constructor() {
    this.searchInput = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-post");
    this.blogsSpinner = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".blogs .loading-box");
    this.searchResults = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-results");
    this.events();
    this.typingTimer;
  ...
  typingLogic(e) {
    ...
    if (e.currentTarget.value) {
      ...
      this.typingTimer = setTimeout(this.getResults.bind(this, e.currentTarget.value), 1000);
    } else {
  ...
  async getResults(input) {
    await jquery__WEBPACK_IMPORTED_MODULE_0___default().when(jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(`${salesXpressData.root_url}/wp-json/salesXpress/v1/search?term=${input}`)).then(posts => {
      //FUNCTION FOR CALCULATING READ TIME BASED ON POST CONTENT
      const getReadTime = content => {
        let wordCount = content.replace(/(<([^>]+)>)/gi, "").replace("\n", "").split(" ").length;
      ...
      const html = posts.reduce((accum, cur) => {
        ...
        const curContent = cur["content"].replace(/(<([^>]+)>)/gi, "").replace("\n", "").substring(0, 80) + " ...";
      ...
      this.searchResults.append(`<h5 class="bold">Unexpected Error, Please Try again later</h5>`);
    });
    this.endSpinner();
    this.isSpinnerVisible = false;
  }
...
/***/ "./src/modules/TestimonySlider.js":
/*!****************************************!*\
  !*** ./src/modules/TestimonySlider.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class TestimonySlider {
  constructor() {
    if (document.querySelector(".testimony-section")) {
      ...
      var glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"](".testimony-section", {
        type: "carousel",
        perView: 2,
        gap: 50,
        breakpoints: {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksales_xpress_theme"] = self["webpackChunksales_xpress_theme"] || [];
